...
class WC_SA_Widget_Watchlist_Auction extends WP_Widget {
	...
	function __construct() {
		...
		$this->woo_widget_description = esc_html__( 'Display a list of auctions on users watchlist.', 'wc_simple_auctions' );
		$this->woo_widget_idbase = 'woocommerce_watchlist_auctions';
		$this->woo_widget_name = esc_html__( 'WooCommerce My Watchlist', 'wc_simple_auctions' );
	...
	function widget($args, $instance) {
		...
		$title = apply_filters('widget_title', empty($instance['title']) ? esc_html__('Auctions Watchlist', 'wc_simple_auctions' ) : $instance['title'], $instance, $this->id_base);
