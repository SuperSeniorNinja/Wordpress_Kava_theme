...
class WC_SA_Widget_Future_Auctions extends WP_Widget {
	...
	function __construct() {
		...
		$this->woo_widget_cssclass = 'woocommerce widget__future_auctions';
		$this->woo_widget_description = esc_html__( 'Display a list of your future auctions on your site.', 'wc_simple_auctions' );
		$this->woo_widget_idbase = 'woocommerce_future_auctions';
		$this->woo_widget_name = esc_html__( 'WooCommerce Future Auctions', 'wc_simple_auctions' );

		/* Widget settings. */
		$widget_ops = array( 'classname' => $this->woo_widget_cssclass, 'description' => $this->woo_widget_description );

		parent::__construct('future_auctions', $this->woo_widget_name, $widget_ops);
	...
	function widget($args, $instance) {
		...
		$title = apply_filters('widget_title', empty($instance['title']) ? esc_html__('Future Auctions', 'wc_simple_auctions' ) : $instance['title'], $instance, $this->id_base);
	...
	function update( $new_instance, $old_instance ) {
		...
		if ( isset($alloptions['widget_future_auctions']) ) delete_option('widget_future_auctions');

		return $instance;
	}

	function flush_widget_cache() {
		wp_cache_delete('widget_future_auctions', 'widget');
	}
