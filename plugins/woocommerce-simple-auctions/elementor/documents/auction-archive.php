...
class Auction_Archive extends Archive {

	public static function get_properties() {
		$properties = parent::get_properties();

		$properties['location'] = 'archive';
		$properties['condition_type'] = 'auction_archive';
	...
	protected static function get_site_editor_tooltip_data() {
		return [
			'title' => esc_html__( 'What is a Auctions Archive Template?', 'elementor-pro' ),
	...
	protected static function get_editor_panel_categories() {
		$categories = [
			'woocommerce-elements-archive' => [
				'title' => esc_html__( 'Auctions Archive', 'elementor-pro' ),
			],
	...
	protected function get_remote_library_config() {
		...
		$config['category'] = 'auction archive';
