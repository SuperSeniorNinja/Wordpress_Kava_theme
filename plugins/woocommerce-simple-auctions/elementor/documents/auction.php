...
class Auction extends Single_Base {

	public static function get_properties() {
		$properties = parent::get_properties();

		$properties['location'] = 'single';
		$properties['condition_type'] = 'auction';
	...
	public static function get_title() {
		return esc_html__( 'Single Auction', 'elementor-pro' );
	}
	...
	public function get_container_attributes() {
		...
		$attributes['class'] .= ' product auction';
	...
	protected static function get_editor_panel_categories() {
		$categories = [
			'woocommerce-elements-single' => [
				'title' => esc_html__( 'Auction', 'elementor-pro' ),
