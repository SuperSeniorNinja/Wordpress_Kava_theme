...
class Archive_Auctions extends Auctions {

	public function get_name() {
		
		return 'wc-archive-auctions';
	}

	public function get_title() {
		return esc_html__( 'Archive Auctions', 'elementor-pro' );
	}
	...
	protected function _register_controls() {
		...
		$this->update_control(
			'auctions_class',
			[
				'prefix_class' => 'elementor-auctions-grid elementor-',
			]
		);
