...
class General extends Page_Module_Base {
	...
	public function get_page_slug() {
		return 'jet-blog-general-settings';
	}
	...
	public function get_page_name() {
		return esc_html__( 'General Settings', 'jet-blog' );
	}
	...
	public function page_templates( $templates = array(), $page = false, $subpage = false ) {
		...
		$templates['jet-blog-general-settings'] = jet_blog()->plugin_path( 'templates/admin-templates/general-settings.php' );
