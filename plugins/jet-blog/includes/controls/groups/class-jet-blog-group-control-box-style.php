...
class Jet_Blog_Group_Control_Box_Style extends Elementor\Group_Control_Base {

	protected static $fields;

	public static function get_type() {
		return 'jet-blog-box-style';
	}
	...
	protected function init_fields() {
		...
		$fields['box_font_color'] = array(
			'label'     => esc_html__( 'Font Color', 'jet-blog' ),
		...
		$fields['box_size'] = array(
			'label'      => esc_html__( 'Box Size', 'jet-blog' ),
			'type'       => Controls_Manager::SLIDER,
			'size_units' => array(
				'px', 'em', '%',
			),
		...
		$fields['box_border'] = array(
			'label'   => _x( 'Border Type', 'Border Control', 'jet-blog' ),
			'type'    => Controls_Manager::SELECT,
			'options' => array(
				''       => __( 'None', 'jet-blog' ),
				'solid'  => _x( 'Solid', 'Border Control', 'jet-blog' ),
				'double' => _x( 'Double', 'Border Control', 'jet-blog' ),
				'dotted' => _x( 'Dotted', 'Border Control', 'jet-blog' ),
				'dashed' => _x( 'Dashed', 'Border Control', 'jet-blog' ),
			),
			'selectors' => array(
		...
		$fields['box_border_width'] = array(
			'label'     => _x( 'Width', 'Border Control', 'jet-blog' ),
		...
		$fields['box_border_color'] = array(
			'label' => _x( 'Color', 'Border Control', 'jet-blog' ),
			'type' => Controls_Manager::COLOR,
			'default' => '',
			'selectors' => array(
		...
		$fields['allow_box_shadow'] = array(
			'label' => _x( 'Box Shadow', 'Box Shadow Control', 'jet-blog' ),
		...
		$fields['box_shadow_position'] = array(
			'label' => _x( 'Position', 'Box Shadow Control', 'jet-blog' ),
			'type' => Controls_Manager::SELECT,
			'options' => array(
				' '     => _x( 'Outline', 'Box Shadow Control', 'jet-blog' ),
				'inset' => _x( 'Inset', 'Box Shadow Control', 'jet-blog' ),
			),
			'condition' => array(
				'allow_box_shadow!' => '',
			),
