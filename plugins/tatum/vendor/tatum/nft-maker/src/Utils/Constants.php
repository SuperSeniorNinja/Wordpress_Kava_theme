...
class Constants
{
    const CONTRACT_ADDRESS = [
        ...
        'MAINNET' => [
            ...
            'XDC' => 'xdc0e072c28331fa01640ca68007a7e98a191a03980',
        ]
    ];
    ...
    const CHAIN_CODES = ['ETH', 'BSC', 'CELO', 'MATIC', 'ONE', 'XDC'];
    const CHAIN_LABELS = [
        'ETH' => 'Ethereum (ETH)',
    ...
    const SUPPORTED_CHAINS_FETCH_NFTS_BY_ADDRESS = ['CELO', 'ALGO', 'MATIC', 'ETH'];
    const PRIVATE_KEY = [
        'MAINNET' => [
            'XDC' => '0xc1e72e093d3f5d4b5b7cd917919b6e5121df38aa624e8d854e9139795892cf83'
        ]
    ];
}