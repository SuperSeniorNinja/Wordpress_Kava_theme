 ...
 * 2. Add unique prefix for the class name, e.g. - Twentyseventeen_Jet_Woo_Product_Gallery_CX_Loader
 ...
 *     new Twentyseventeen_Jet_Woo_Product_Gallery_CX_Loader(
 *         array(
 ...
 * 2. You should manually initialize selected modules later, when them will be needed you, but not earlier than
...
if ( ! class_exists( 'Jet_Woo_Product_Gallery_CX_Loader' ) ) {

	/**
	 * Define Jet_Woo_Product_Gallery_CX_Loader class
	 */
	class Jet_Woo_Product_Gallery_CX_Loader {
