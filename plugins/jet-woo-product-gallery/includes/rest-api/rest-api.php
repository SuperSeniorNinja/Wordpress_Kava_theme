...
class Rest_Api {
	...
	/**
	 * Contain rest api namespace
	 *
	 * @var string
	 */
	public $api_namespace = 'jet-woo-product-gallery-api/v1';

	/**
	 * A reference to endpoints
	 *
	 * @var null
	 */
	...
	public function init_endpoints() {
		...
		do_action( 'jet-woo-product-gallery-api/rest/init-endpoints', $this );
