...
class Premium_Progressbar extends Widget_Base {
		...
		<div <?php echo wp_kses_post( $this->get_render_attribute_string( 'progressbar' ) ); ?>>
					...
					if ( 'center' === $this->get_settings( 'premium_progressbar_more_labels_align' ) ) {
						if ( 'yes' === $settings['premium_progress_bar_space_percentage_switcher'] ) {
							if ( 'arrow' === $settings['premium_progressbar_select_label_icon'] ) {
								echo '<div class="premium-progressbar-multiple-label" style="' . $direction . ':' . $item['number'] . '%;"><p class = "premium-progressbar-center-label" style="transform:translateX(-45%);">' . $item['text'] . ' <span class="premium-progressbar-percentage">' . $item['number'] . '%</span></p><p class="premium-progressbar-arrow" style="' . $direction . ':' . $item['number'] . '%; transform:translateX(50%);"></p></div>';
							} elseif ( 'line_pin' === $settings['premium_progressbar_select_label_icon'] ) {
								echo '<div class="premium-progressbar-multiple-label" style="' . $direction . ':' . $item['number'] . '%;"><p class = "premium-progressbar-center-label" style="transform:translateX(-45%);">' . $item['text'] . ' <span class="premium-progressbar-percentage">' . $item['number'] . '%</span></p><p class="premium-progressbar-pin" style="' . $direction . ':' . $item['number'] . '%; transform:translateX(50%);"></p></div>';
							} else {
								echo '<div class="premium-progressbar-multiple-label" style="' . $direction . ':' . $item['number'] . '%;"><p class = "premium-progressbar-center-label" style="transform:translateX(-45%);">' . $item['text'] . ' <span class="premium-progressbar-percentage">' . $item['number'] . '%</span></p></div>';
							}
						} else {
							if ( 'arrow' === $settings['premium_progressbar_select_label_icon'] ) {
								echo '<div class="premium-progressbar-multiple-label" style="' . $direction . ':' . $item['number'] . '%;"><p class = "premium-progressbar-center-label" style="transform:translateX(-45%);">' . $item['text'] . '</p><p class="premium-progressbar-arrow" style="' . $direction . ':' . $item['number'] . '%; transform:translateX(50%);"></p></div>';
							} elseif ( 'line_pin' === $settings['premium_progressbar_select_label_icon'] ) {
								echo '<div class="premium-progressbar-multiple-label" style="' . $direction . ':' . $item['number'] . '%;"><p class = "premium-progressbar-center-label" style="transform:translateX(-45%)">' . $item['text'] . '</p><p class="premium-progressbar-pin" style="' . $direction . ':' . $item['number'] . '%; transform:translateX(50%);"></p></div>';
							} else {
								echo '<div class="premium-progressbar-multiple-label" style="' . $direction . ':' . $item['number'] . '%;"><p class = "premium-progressbar-center-label" style="transform:translateX(-45%);">' . $item['text'] . '</p></div>';
							}
						}
					} elseif ( 'left' === $this->get_settings( 'premium_progressbar_more_labels_align' ) ) {
						if ( 'yes' === $settings['premium_progress_bar_space_percentage_switcher'] ) {
							if ( 'arrow' === $settings['premium_progressbar_select_label_icon'] ) {
								echo '<div class="premium-progressbar-multiple-label" style="' . $direction . ':' . $item['number'] . '%;"><p class = "premium-progressbar-center-label" style="transform:translateX(-10%);">' . $item['text'] . ' <span class="premium-progressbar-percentage">' . $item['number'] . '%</span></p><p class="premium-progressbar-arrow" style="' . $direction . ':' . $item['number'] . '%; transform:translateX(50%);"></p></div>';
							} elseif ( 'line_pin' === $settings['premium_progressbar_select_label_icon'] ) {
								echo '<div class="premium-progressbar-multiple-label" style="' . $direction . ':' . $item['number'] . '%;"><p class = "premium-progressbar-center-label" style="transform:translateX(-2%);">' . $item['text'] . ' <span class="premium-progressbar-percentage">' . $item['number'] . '%</span></p><p class="premium-progressbar-pin" style="' . $direction . ':' . $item['number'] . '%; transform:translateX(50%);"></p></div>';
							} else {
								echo '<div class="premium-progressbar-multiple-label" style="' . $direction . ':' . $item['number'] . '%;"><p class = "premium-progressbar-center-label" style="transform:translateX(-2%);">' . $item['text'] . ' <span class="premium-progressbar-percentage">' . $item['number'] . '%</span></p></div>';
							}
						} else {
							if ( 'arrow' === $settings['premium_progressbar_select_label_icon'] ) {
								echo '<div class="premium-progressbar-multiple-label" style="' . $direction . ':' . $item['number'] . '%;"><p class = "premium-progressbar-center-label" style="transform:translateX(-10%);">' . $item['text'] . '</p><p class="premium-progressbar-arrow" style="' . $direction . ':' . $item['number'] . '%; transform:translateX(50%);"></p></div>';
							} elseif ( 'line_pin' === $settings['premium_progressbar_select_label_icon'] ) {
								echo '<div class="premium-progressbar-multiple-label" style="' . $direction . ':' . $item['number'] . '%;"><p class = "premium-progressbar-center-label" style="transform:translateX(-2%);">' . $item['text'] . '</p><p class="premium-progressbar-pin" style="' . $direction . ':' . $item['number'] . '%; transform:translateX(50%);"></p></div>';
							} else {
								echo '<div class="premium-progressbar-multiple-label" style="' . $direction . ':' . $item['number'] . '%;"><p class = "premium-progressbar-center-label" style="transform:translateX(-2%);">' . $item['text'] . '</p></div>';
							}
						}
					} else {
						if ( 'yes' === $settings['premium_progress_bar_space_percentage_switcher'] ) {
							if ( 'arrow' === $settings['premium_progressbar_select_label_icon'] ) {
								echo '<div class="premium-progressbar-multiple-label" style="' . $direction . ':' . $item['number'] . '%;"><p class = "premium-progressbar-center-label" style="transform:translateX(-82%);">' . $item['text'] . ' <span class="premium-progressbar-percentage">' . $item['number'] . '%</span></p><p class="premium-progressbar-arrow" style="' . $direction . ':' . $item['number'] . '%; transform:translateX(50%);"></p></div>';
							} elseif ( 'line_pin' === $settings['premium_progressbar_select_label_icon'] ) {
								echo '<div class="premium-progressbar-multiple-label" style="' . $direction . ':' . $item['number'] . '%;"><p class = "premium-progressbar-center-label" style="transform:translateX(-95%);">' . $item['text'] . ' <span class="premium-progressbar-percentage">' . $item['number'] . '%</span></p><p class="premium-progressbar-pin" style="' . $direction . ':' . $item['number'] . '%; transform:translateX(50%);"></p></div>';
							} else {
								echo '<div class="premium-progressbar-multiple-label" style="' . $direction . ':' . $item['number'] . '%;"><p class = "premium-progressbar-center-label" style="transform:translateX(-96%);">' . $item['text'] . ' <span class="premium-progressbar-percentage">' . $item['number'] . '%</span></p></div>';
							}
						} else {
							if ( 'arrow' === $settings['premium_progressbar_select_label_icon'] ) {
								echo '<div class="premium-progressbar-multiple-label" style="' . $direction . ':' . $item['number'] . '%;"><p class = "premium-progressbar-center-label" style="transform:translateX(-71%);">' . $item['text'] . '</p><p class="premium-progressbar-arrow" style="' . $direction . ':' . $item['number'] . '%; transform:translateX(50%);"></p></div>';
							} elseif ( 'line_pin' === $settings['premium_progressbar_select_label_icon'] ) {
								echo '<div class="premium-progressbar-multiple-label" style="' . $direction . ':' . $item['number'] . '%;"><p class = "premium-progressbar-center-label" style="transform:translateX(-97%);">' . $item['text'] . '</p><p class="premium-progressbar-pin" style="' . $direction . ':' . $item['number'] . '%; transform:translateX(50%);"></p></div>';
							} else {
								echo '<div class="premium-progressbar-multiple-label" style="' . $direction . ':' . $item['number'] . '%;"><p class = "premium-progressbar-center-label" style="transform:translateX(-96%);">' . $item['text'] . '</p></div>';
							}
						}
					}
				}
			...
			<div <?php echo wp_kses_post( $this->get_render_attribute_string( 'wrap' ) ); ?>>
				...
				<?php elseif ( 'circle' === $type ) : ?>
					...
					<?php $this->get_progressbar_content(); ?>
	 ...
	 * @access private
	 */
	private function get_progressbar_content() {
