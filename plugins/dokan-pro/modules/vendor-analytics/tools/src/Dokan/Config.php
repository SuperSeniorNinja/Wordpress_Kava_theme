...
class Dokan_Config
{
  ...
  public function __construct($ini_file_location = null)
  {
    $this->configuration = array(
      ...
      'auth_class'    => 'Dokan_Auth_OAuth2',
      'io_class'      => self::USE_AUTO_IO_SELECTION,
      'cache_class'   => 'Dokan_Cache_File',
      'logger_class'  => 'Dokan_Logger_Null',
      ...
      'classes' => array(
        ...
        'Dokan_Logger_Abstract' => array(
          'level' => 'debug',
          'log_format' => "[%datetime%] %level%: %message% %context%\n",
          'date_format' => 'd/M/Y:H:i:s O',
          'allow_newlines' => true
        ),
        'Dokan_Logger_File' => array(
          'file' => 'php://stdout',
          'mode' => 0640,
          'lock' => false,
        ),
        'Dokan_Http_Request' => array(
        ...
        'Dokan_Cache_File' => array(
          'directory' => sys_get_temp_dir() . '/Dokan_Client'
        )
      ),
    );
