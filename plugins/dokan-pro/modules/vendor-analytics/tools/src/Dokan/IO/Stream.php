...
/**
 * Http Streams based implementation of Dokan_IO.
 *
...
class Dokan_IO_Stream extends Dokan_IO_Abstract
{
  ...
  public function __construct(Dokan_Client $client)
  {
    if (!ini_get('allow_url_fopen')) {
      ...
      throw new Dokan_IO_Exception($error);
    }
  ...
  public function executeRequest(Dokan_Http_Request $request)
  {
    ...
    $requestSslContext = apply_filters('dokan_analytics_endpoint_stream_options', $requestSslContext, $request);
    ...
    if ($this->trappedErrorNumber) {
      ...
      throw new Dokan_IO_Exception($error, $this->trappedErrorNumber);
    }
    ...
    if (false === $response_data) {
      ...
      $this->client->getLogger()->error('Stream ' . $error);
      throw new Dokan_IO_Exception($error, $respHttpCode);
    }
