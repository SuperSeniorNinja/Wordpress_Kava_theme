...
class Dokan_Http_Batch
{
  ...
  public function execute()
  {
    ...
    $httpRequest = new Dokan_Http_Request($url, 'POST');
    ...
    if ($body) {
      ...
      foreach ($parts as $part) {
        ...
        if (!empty($part)) {
          ...
          $response = new Dokan_Http_Request("");
          ...
          try {
            $response = Dokan_Http_REST::decodeHttpResponse($response, $this->client);
            $responses[$key] = $response;
          } catch (Dokan_Service_Exception $e) {
