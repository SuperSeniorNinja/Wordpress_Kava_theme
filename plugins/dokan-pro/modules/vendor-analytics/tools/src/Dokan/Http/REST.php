...
class Dokan_Http_REST
{
   ...
   * @return mixed|null
   */
  public static function decodeHttpResponse($response, Dokan_Client $client = null)
  {
    ...
    if ((intVal($code)) >= 300) {
      ...
      if ($client) {
        ...
        $map = $client->getClassConfig(
            'Dokan_Service_Exception',
            'retry_map'
        );
      }
      throw new Dokan_Service_Exception($err, $code, null, $errors, $map);
    }
    ...
    if ($code != '204') {
      ...
      if ($decoded === null || $decoded === "") {
        ...
        throw new Dokan_Service_Exception($error);
      }
  ...
  public static function createRequestUri($servicePath, $restPath, $params)
  {
    ...
    if (count($uriTemplateVars)) {
      $uriTemplateParser = new Dokan_Utils_URITemplate();
