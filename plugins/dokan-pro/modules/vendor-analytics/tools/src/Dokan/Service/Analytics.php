...
class Dokan_Service_Analytics extends Dokan_Service
{
  ...
  public function __construct(Dokan_Client $client)
  {
    ...
    $this->data_ga = new Dokan_Service_Analytics_DataGa_Resource(
        $this,
        $this->serviceName,
        'ga',
        array(
    ...
    $this->data_mcf = new Dokan_Service_Analytics_DataMcf_Resource(
        $this,
        $this->serviceName,
        'mcf',
        array(
    ...
    $this->data_realtime = new Dokan_Service_Analytics_DataRealtime_Resource(
        $this,
        $this->serviceName,
        'realtime',
        array(
    ...
    $this->management_accountSummaries = new Dokan_Service_Analytics_ManagementAccountSummaries_Resource(
        $this,
        $this->serviceName,
        'accountSummaries',
        array(
    ...
    $this->management_accountUserLinks = new Dokan_Service_Analytics_ManagementAccountUserLinks_Resource(
        $this,
        $this->serviceName,
        'accountUserLinks',
        array(
    ...
    $this->management_accounts = new Dokan_Service_Analytics_ManagementAccounts_Resource(
        $this,
        $this->serviceName,
        'accounts',
        array(
    ...
    $this->management_customDataSources = new Dokan_Service_Analytics_ManagementCustomDataSources_Resource(
        $this,
        $this->serviceName,
        'customDataSources',
        array(
    ...
    $this->management_customDimensions = new Dokan_Service_Analytics_ManagementCustomDimensions_Resource(
        $this,
        $this->serviceName,
        'customDimensions',
        array(
    ...
    $this->management_customMetrics = new Dokan_Service_Analytics_ManagementCustomMetrics_Resource(
        $this,
        $this->serviceName,
        'customMetrics',
        array(
    ...
    $this->management_experiments = new Dokan_Service_Analytics_ManagementExperiments_Resource(
        $this,
        $this->serviceName,
        'experiments',
        array(
    ...
    $this->management_filters = new Dokan_Service_Analytics_ManagementFilters_Resource(
        $this,
        $this->serviceName,
        'filters',
        array(
    ...
    $this->management_goals = new Dokan_Service_Analytics_ManagementGoals_Resource(
        $this,
        $this->serviceName,
        'goals',
        array(
    ...
    $this->management_profileFilterLinks = new Dokan_Service_Analytics_ManagementProfileFilterLinks_Resource(
        $this,
        $this->serviceName,
        'profileFilterLinks',
        array(
    ...
    $this->management_profileUserLinks = new Dokan_Service_Analytics_ManagementProfileUserLinks_Resource(
        $this,
        $this->serviceName,
        'profileUserLinks',
        array(
    ...
    $this->management_profiles = new Dokan_Service_Analytics_ManagementProfiles_Resource(
        $this,
        $this->serviceName,
        'profiles',
        array(
    ...
    $this->management_segments = new Dokan_Service_Analytics_ManagementSegments_Resource(
        $this,
        $this->serviceName,
        'segments',
        array(
    ...
    $this->management_unsampledReports = new Dokan_Service_Analytics_ManagementUnsampledReports_Resource(
        $this,
        $this->serviceName,
        'unsampledReports',
        array(
    ...
    $this->management_uploads = new Dokan_Service_Analytics_ManagementUploads_Resource(
        $this,
        $this->serviceName,
        'uploads',
        array(
    ...
    $this->management_webPropertyAdWordsLinks = new Dokan_Service_Analytics_ManagementWebPropertyAdWordsLinks_Resource(
        $this,
        $this->serviceName,
    ...
    $this->management_webproperties = new Dokan_Service_Analytics_ManagementWebproperties_Resource(
        $this,
        $this->serviceName,
        'webproperties',
        array(
    ...
    $this->management_webpropertyUserLinks = new Dokan_Service_Analytics_ManagementWebpropertyUserLinks_Resource(
        $this,
        $this->serviceName,
    ...
    $this->metadata_columns = new Dokan_Service_Analytics_MetadataColumns_Resource(
        $this,
        $this->serviceName,
        'columns',
        array(
    ...
    $this->provisioning = new Dokan_Service_Analytics_Provisioning_Resource(
        $this,
        $this->serviceName,
        'provisioning',
        array(
...
class Dokan_Service_Analytics_DataGa_Resource extends Dokan_Service_Resource
{
  ...
  public function get($ids, $startDate, $endDate, $metrics, $optParams = array())
  {
    ...
    return $this->call('get', array($params), "Dokan_Service_Analytics_GaData");
  }
}
/**
...
class Dokan_Service_Analytics_DataMcf_Resource extends Dokan_Service_Resource
{
  ...
  public function get($ids, $startDate, $endDate, $metrics, $optParams = array())
  {
    $params = array('ids' => $ids, 'start-date' => $startDate, 'end-date' => $endDate, 'metrics' => $metrics);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Dokan_Service_Analytics_McfData");
  }
}
/**
...
class Dokan_Service_Analytics_DataRealtime_Resource extends Dokan_Service_Resource
{
  ...
  public function get($ids, $metrics, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Dokan_Service_Analytics_RealtimeData");
  }
}
...
class Dokan_Service_Analytics_ManagementAccountSummaries_Resource extends Dokan_Service_Resource
{
  ...
  public function listManagementAccountSummaries($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Dokan_Service_Analytics_AccountSummaries");
  }
}
/**
...
class Dokan_Service_Analytics_ManagementAccountUserLinks_Resource extends Dokan_Service_Resource
{
  ...
  public function insert($accountId, Dokan_Service_Analytics_EntityUserLink $postBody, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "Dokan_Service_Analytics_EntityUserLink");
  }
  ...
  public function listManagementAccountUserLinks($accountId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Dokan_Service_Analytics_EntityUserLinks");
  }
  ...
  public function update($accountId, $linkId, Dokan_Service_Analytics_EntityUserLink $postBody, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Dokan_Service_Analytics_EntityUserLink");
  }
}
/**
...
class Dokan_Service_Analytics_ManagementAccounts_Resource extends Dokan_Service_Resource
{
  ...
  public function listManagementAccounts($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Dokan_Service_Analytics_Accounts");
  }
}
/**
...
class Dokan_Service_Analytics_ManagementCustomDataSources_Resource extends Dokan_Service_Resource
{
  ...
  public function listManagementCustomDataSources($accountId, $webPropertyId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Dokan_Service_Analytics_CustomDataSources");
  }
}
/**
...
class Dokan_Service_Analytics_ManagementCustomDimensions_Resource extends Dokan_Service_Resource
{
  ...
  public function get($accountId, $webPropertyId, $customDimensionId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Dokan_Service_Analytics_CustomDimension");
  }
  ...
  public function insert($accountId, $webPropertyId, Dokan_Service_Analytics_CustomDimension $postBody, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "Dokan_Service_Analytics_CustomDimension");
  }
  ...
  public function listManagementCustomDimensions($accountId, $webPropertyId, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Dokan_Service_Analytics_CustomDimensions");
  }
  ...
  public function patch($accountId, $webPropertyId, $customDimensionId, Dokan_Service_Analytics_CustomDimension $postBody, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Dokan_Service_Analytics_CustomDimension");
  }
  ...
  public function update($accountId, $webPropertyId, $customDimensionId, Dokan_Service_Analytics_CustomDimension $postBody, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'customDimensionId' => $customDimensionId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Dokan_Service_Analytics_CustomDimension");
  }
}
/**
...
class Dokan_Service_Analytics_ManagementCustomMetrics_Resource extends Dokan_Service_Resource
{
  ...
  public function get($accountId, $webPropertyId, $customMetricId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Dokan_Service_Analytics_CustomMetric");
  }
  ...
  public function insert($accountId, $webPropertyId, Dokan_Service_Analytics_CustomMetric $postBody, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "Dokan_Service_Analytics_CustomMetric");
  }
  ...
  public function listManagementCustomMetrics($accountId, $webPropertyId, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Dokan_Service_Analytics_CustomMetrics");
  }
  ...
  public function patch($accountId, $webPropertyId, $customMetricId, Dokan_Service_Analytics_CustomMetric $postBody, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Dokan_Service_Analytics_CustomMetric");
  }
  ...
  public function update($accountId, $webPropertyId, $customMetricId, Dokan_Service_Analytics_CustomMetric $postBody, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'customMetricId' => $customMetricId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Dokan_Service_Analytics_CustomMetric");
  }
}
/**
...
class Dokan_Service_Analytics_ManagementExperiments_Resource extends Dokan_Service_Resource
{
  ...
  public function get($accountId, $webPropertyId, $profileId, $experimentId, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'profileId' => $profileId, 'experimentId' => $experimentId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Dokan_Service_Analytics_Experiment");
  }
  ...
  public function insert($accountId, $webPropertyId, $profileId, Dokan_Service_Analytics_Experiment $postBody, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "Dokan_Service_Analytics_Experiment");
  }
  ...
  public function listManagementExperiments($accountId, $webPropertyId, $profileId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Dokan_Service_Analytics_Experiments");
  }
  ...
  public function patch($accountId, $webPropertyId, $profileId, $experimentId, Dokan_Service_Analytics_Experiment $postBody, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Dokan_Service_Analytics_Experiment");
  }
  ...
  public function update($accountId, $webPropertyId, $profileId, $experimentId, Dokan_Service_Analytics_Experiment $postBody, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'profileId' => $profileId, 'experimentId' => $experimentId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Dokan_Service_Analytics_Experiment");
  }
}
/**
...
class Dokan_Service_Analytics_ManagementFilters_Resource extends Dokan_Service_Resource
{
  ...
  public function delete($accountId, $filterId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('delete', array($params), "Dokan_Service_Analytics_Filter");
  }
  ...
  public function get($accountId, $filterId, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'filterId' => $filterId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Dokan_Service_Analytics_Filter");
  }
  ...
  public function insert($accountId, Dokan_Service_Analytics_Filter $postBody, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "Dokan_Service_Analytics_Filter");
  }
  ...
  public function listManagementFilters($accountId, $optParams = array())
  {
    $params = array('accountId' => $accountId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Dokan_Service_Analytics_Filters");
  }
  ...
  public function patch($accountId, $filterId, Dokan_Service_Analytics_Filter $postBody, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Dokan_Service_Analytics_Filter");
  }
  ...
  public function update($accountId, $filterId, Dokan_Service_Analytics_Filter $postBody, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'filterId' => $filterId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Dokan_Service_Analytics_Filter");
  }
}
/**
...
class Dokan_Service_Analytics_ManagementGoals_Resource extends Dokan_Service_Resource
{
  ...
  public function get($accountId, $webPropertyId, $profileId, $goalId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Dokan_Service_Analytics_Goal");
  }
  ...
  public function insert($accountId, $webPropertyId, $profileId, Dokan_Service_Analytics_Goal $postBody, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'profileId' => $profileId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "Dokan_Service_Analytics_Goal");
  }
  ...
  public function listManagementGoals($accountId, $webPropertyId, $profileId, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'profileId' => $profileId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Dokan_Service_Analytics_Goals");
  }
  ...
  public function patch($accountId, $webPropertyId, $profileId, $goalId, Dokan_Service_Analytics_Goal $postBody, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Dokan_Service_Analytics_Goal");
  }
  ...
  public function update($accountId, $webPropertyId, $profileId, $goalId, Dokan_Service_Analytics_Goal $postBody, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'profileId' => $profileId, 'goalId' => $goalId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Dokan_Service_Analytics_Goal");
  }
}
/**
...
class Dokan_Service_Analytics_ManagementProfileFilterLinks_Resource extends Dokan_Service_Resource
{
  ...
  public function get($accountId, $webPropertyId, $profileId, $linkId, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'profileId' => $profileId, 'linkId' => $linkId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Dokan_Service_Analytics_ProfileFilterLink");
  }
  ...
  public function insert($accountId, $webPropertyId, $profileId, Dokan_Service_Analytics_ProfileFilterLink $postBody, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'profileId' => $profileId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "Dokan_Service_Analytics_ProfileFilterLink");
  }
  ...
  public function listManagementProfileFilterLinks($accountId, $webPropertyId, $profileId, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'profileId' => $profileId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Dokan_Service_Analytics_ProfileFilterLinks");
  }
  ...
  public function patch($accountId, $webPropertyId, $profileId, $linkId, Dokan_Service_Analytics_ProfileFilterLink $postBody, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Dokan_Service_Analytics_ProfileFilterLink");
  }
  ...
  public function update($accountId, $webPropertyId, $profileId, $linkId, Dokan_Service_Analytics_ProfileFilterLink $postBody, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'profileId' => $profileId, 'linkId' => $linkId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Dokan_Service_Analytics_ProfileFilterLink");
  }
}
/**
...
class Dokan_Service_Analytics_ManagementProfiles_Resource extends Dokan_Service_Resource
{
  ...
  public function get($accountId, $webPropertyId, $profileId, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'profileId' => $profileId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Dokan_Service_Analytics_Profile");
  }
  ...
  public function insert($accountId, $webPropertyId, Dokan_Service_Analytics_Profile $postBody, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "Dokan_Service_Analytics_Profile");
  }
  ...
  public function listManagementProfiles($accountId, $webPropertyId, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Dokan_Service_Analytics_Profiles");
  }
  ...
  public function patch($accountId, $webPropertyId, $profileId, Dokan_Service_Analytics_Profile $postBody, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'profileId' => $profileId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Dokan_Service_Analytics_Profile");
  }
  ...
  public function update($accountId, $webPropertyId, $profileId, Dokan_Service_Analytics_Profile $postBody, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'profileId' => $profileId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Dokan_Service_Analytics_Profile");
  }
}
/**
...
class Dokan_Service_Analytics_ManagementSegments_Resource extends Dokan_Service_Resource
{
  ...
  public function listManagementSegments($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Dokan_Service_Analytics_Segments");
  }
}
/**
...
class Dokan_Service_Analytics_ManagementUnsampledReports_Resource extends Dokan_Service_Resource
{
  ...
  public function get($accountId, $webPropertyId, $profileId, $unsampledReportId, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'profileId' => $profileId, 'unsampledReportId' => $unsampledReportId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Dokan_Service_Analytics_UnsampledReport");
  }
  ...
  public function insert($accountId, $webPropertyId, $profileId, Dokan_Service_Analytics_UnsampledReport $postBody, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'profileId' => $profileId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "Dokan_Service_Analytics_UnsampledReport");
  }
  ...
  public function listManagementUnsampledReports($accountId, $webPropertyId, $profileId, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'profileId' => $profileId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Dokan_Service_Analytics_UnsampledReports");
  }
}
/**
...
class Dokan_Service_Analytics_ManagementUploads_Resource extends Dokan_Service_Resource
{
  ...
  public function get($accountId, $webPropertyId, $customDataSourceId, $uploadId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Dokan_Service_Analytics_Upload");
  }
  ...
  public function listManagementUploads($accountId, $webPropertyId, $customDataSourceId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Dokan_Service_Analytics_Uploads");
  }
  ...
  public function uploadData($accountId, $webPropertyId, $customDataSourceId, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'customDataSourceId' => $customDataSourceId);
    $params = array_merge($params, $optParams);
    return $this->call('uploadData', array($params), "Dokan_Service_Analytics_Upload");
  }
}
/**
...
class Dokan_Service_Analytics_ManagementWebPropertyAdWordsLinks_Resource extends Dokan_Service_Resource
{
  ...
  public function get($accountId, $webPropertyId, $webPropertyAdWordsLinkId, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'webPropertyAdWordsLinkId' => $webPropertyAdWordsLinkId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Dokan_Service_Analytics_EntityAdWordsLink");
  }
  ...
  public function insert($accountId, $webPropertyId, Dokan_Service_Analytics_EntityAdWordsLink $postBody, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "Dokan_Service_Analytics_EntityAdWordsLink");
  }
  ...
  public function listManagementWebPropertyAdWordsLinks($accountId, $webPropertyId, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Dokan_Service_Analytics_EntityAdWordsLinks");
  }
  ...
  public function patch($accountId, $webPropertyId, $webPropertyAdWordsLinkId, Dokan_Service_Analytics_EntityAdWordsLink $postBody, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Dokan_Service_Analytics_EntityAdWordsLink");
  }
  ...
  public function update($accountId, $webPropertyId, $webPropertyAdWordsLinkId, Dokan_Service_Analytics_EntityAdWordsLink $postBody, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'webPropertyAdWordsLinkId' => $webPropertyAdWordsLinkId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Dokan_Service_Analytics_EntityAdWordsLink");
  }
}
/**
...
class Dokan_Service_Analytics_ManagementWebproperties_Resource extends Dokan_Service_Resource
{
  ...
  public function get($accountId, $webPropertyId, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Dokan_Service_Analytics_Webproperty");
  }
  ...
  public function insert($accountId, Dokan_Service_Analytics_Webproperty $postBody, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "Dokan_Service_Analytics_Webproperty");
  }
  ...
  public function listManagementWebproperties($accountId, $optParams = array())
  {
    $params = array('accountId' => $accountId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Dokan_Service_Analytics_Webproperties");
  }
  ...
  public function patch($accountId, $webPropertyId, Dokan_Service_Analytics_Webproperty $postBody, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Dokan_Service_Analytics_Webproperty");
  }
  ...
  public function update($accountId, $webPropertyId, Dokan_Service_Analytics_Webproperty $postBody, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Dokan_Service_Analytics_Webproperty");
  }
}
/**
...
class Dokan_Service_Analytics_MetadataColumns_Resource extends Dokan_Service_Resource
{
  ...
  public function listMetadataColumns($reportType, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Dokan_Service_Analytics_Columns");
  }
}
...
class Dokan_Service_Analytics_Provisioning_Resource extends Dokan_Service_Resource
{
  ...
  public function createAccountTicket(Dokan_Service_Analytics_AccountTicket $postBody, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('createAccountTicket', array($params), "Dokan_Service_Analytics_AccountTicket");
  }
}
