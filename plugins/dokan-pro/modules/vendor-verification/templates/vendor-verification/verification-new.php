                                    ...
                                    <div class="dokan-vendor-company-files">
                                        ...
                                        ?>
                                            <div class="dokan-vendor-company-file-item" id="<?php echo $customId; ?>">
                                                ...
                                                <a href="#" onclick="companyVerificationRemoveList(event)" data-attachment_id="<?php echo $customId; ?>" class="dokan-btn dokan-btn-danger"><i class="fas fa-times" data-attachment_id="<?php echo $customId; ?>"></i></a>
