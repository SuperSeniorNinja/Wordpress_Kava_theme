<tr>
	...
	<td class="file_url"><input type="text" class="input_text wc_file_url" placeholder="<?php _e( "http://", 'dokan' ); ?>" name="_wc_variation_file_urls[<?php echo $variation_id; ?>][]" value="<?php echo esc_attr( $file['file'] ); ?>" /></td>
	...
	<td width="1%"><a href="#" class="dokan-btn dokan-btn-sm dokan-btn-danger dokan-product-delete"><?php _e( 'Delete', 'dokan' ); ?></a></td>
</tr>
