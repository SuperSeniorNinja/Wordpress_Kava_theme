...
<article class="dokan-notice-single-notice-area">
    ...
    <span class="dokan-single-announcement-date"><i class="far fa-calendar-alt"></i> <?php echo date_i18n( get_option( 'date_format' ), strtotime( $notice_data->post_date ) ); ?></span>
