...
<div style="padding: 10px 0 50px 0;text-align: center">To review this member please click the following link: <a style="color: #3ba1da;text-decoration: none" href="{user_profile_link}">{user_profile_link}</a></div>
